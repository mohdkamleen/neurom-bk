    ...
    components: {
      ...
      schemas: {
        ...
        FoodNutrition: {
          type: "object",
          description:
            "Per-serving nutrients. Macros/fats in g; cholesterol/sodium/minerals in mg; vitaminA/D/K/folate/B12/selenium in µg.",
          properties: {
            ...
            water:              { type: "number", example: 83.6 },
            saturatedFat:       { type: "number", example: 0.03 },
            monounsaturatedFat: { type: "number", example: 0.01 },
            polyunsaturatedFat: { type: "number", example: 0.05 },
            transFat:           { type: "number", example: 0 },
            cholesterol:        { type: "number", example: 0 },
            salt:               { type: "number", example: 0.003 },
            sodium:             { type: "number", example: 1.01 },
            potassium:          { type: "number", example: 103.8 },
            calcium:            { type: "number", example: 5.98 },
            iron:               { type: "number", example: 0.02 },
            magnesium:          { type: "number", example: 4.67 },
            phosphorus:         { type: "number", example: 9.78 },
            zinc:               { type: "number", example: 0.02 },
            copper:             { type: "number", example: 0.03 },
            manganese:          { type: "number", example: 0.03 },
            selenium:           { type: "number", example: 0 },
            vitaminA:           { type: "number", example: 3 },
            vitaminC:           { type: "number", example: 4.6 },
            vitaminD:           { type: "number", example: 0 },
            vitaminE:           { type: "number", example: 0.18 },
            vitaminK:           { type: "number", example: 2.2 },
            thiamin:            { type: "number", example: 0.006 },
            riboflavin:         { type: "number", example: 0.068 },
            niacin:             { type: "number", example: 0.091 },
            vitaminB6:          { type: "number", example: 0.035 },
            folate:             { type: "number", example: 0 },
            vitaminB12:         { type: "number", example: 0 },
            choline:            { type: "number", example: 3.4 },
            caffeine:           { type: "number", example: 0 },
            sucrose:            { type: "number", example: 1.7 },
            glucose:            { type: "number", example: 3.04 },
            fructose:           { type: "number", example: 8.59 },
          },
        },
        FoodItem: {
          type: "object",
